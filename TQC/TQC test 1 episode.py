...
from utils import get_push_dense_env, get_push_dense_env_test, get_push_dense_env_test_human, get_push_dense_env_test_human_1ep
...
def evaluate_policy(
    ...
    if return_episode_rewards:
        return episode_rewards, episode_lengths, my_episode_counter
    return mean_reward, std_reward, my_episode_counter
...
def test_human_view(user_input = 100):
    file_path = os.getcwd()
    interaction_dir = os.path.join(file_path, "interactions/TQC/")

    env5 = get_push_dense_env_test_human_1ep(1.0, 0.001, 20, 5, interaction_dir)
